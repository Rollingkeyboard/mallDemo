    ...
    <div class="addwrap">
        <div class="addl fl">
            ...
            <form name="publish-form" id="publish-form" action="do_edit.php" method="post"
                ...
                <div class="additem">
                    <label id="for-name">画品名称</label><input type="text" name="name" id="name" placeholder="请输入画品名称" value="<?php echo $res[0]['name']; ?>">
                </div>
                <div class="additem">
                    <label id="for-price">价值</label><input type="text" name="price" id="price" placeholder="请输入画品价值" value="<?php echo $res[0]['price']; ?>" >
                </div>
                <div class="additem">
                ...
                <div class="additem textwrap">
                    ...
                    <textarea id="des" name="des" placeholder="请输入画品简介"><?php echo $res[0]['des']; ?></textarea>
                </div>
                <div class="additem textwrap">
                    <label class="ptop" id="for-content">画品详情</label>
                    <div style="margin-left: 120px" id="container">
                        <textarea id="content" name="content"><?php echo $res[0]['content']; ?></textarea>
                    </div>
